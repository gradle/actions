...
export class CacheCleaner {
    ...
    async forceCleanupFilesOlderThan(cleanTimestamp: string) {
        ...
        const gradleCommand = `gradle -g ${this.gradleUserHome} -I init.gradle --no-daemon --build-cache --no-scan --quiet -DGITHUB_DEPENDENCY_GRAPH_ENABLED=false noop`
